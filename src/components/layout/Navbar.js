                ...
                <div className = "container">
                    ...
                    <div className="right">
                        <ul  className = "hide-on-med-and-down">
                            <li className = { this.state.index === 0 ? "active text-bold" : null } onClick = { () => this.handleClick(0) }><NavLink className = "waves-effect" title = "About" to = "/">About</NavLink></li>
                            <li className = { this.state.index === 1 ? "active text-bold" : null } onClick = { () => this.handleClick(1) }><NavLink className = "waves-effect" title = "Work and Education" to = "/worknedu">Work and Education</NavLink></li>
                            <li className = { this.state.index === 2 ? "active text-bold" : null } onClick = { () => this.handleClick(2) }><NavLink className = "waves-effect" title = "Projects" to = "/projects">Projects</NavLink></li>
                            <li className = { this.state.index === 3 ? "active text-bold" : null } onClick = { () => this.handleClick(3) }><NavLink className = "waves-effect" title = "Skills" to = "/skills">Skills</NavLink></li>
